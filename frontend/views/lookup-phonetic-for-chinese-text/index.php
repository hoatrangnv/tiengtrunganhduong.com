...
$chinese_text_analyzer_src = Yii::getAlias('@web/js/chinese_text_analyzer.js?v=11');
?>
...
<script>
    ...
    window.isUseWorker = true; // worker is usually slower than main thread. but use main thread will block UI.
