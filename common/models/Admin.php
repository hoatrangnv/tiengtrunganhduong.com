 ...
 */
class Admin extends \common\models\MyActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(Article::className(), ['creator_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Image::className(), ['creator_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Image::className(), ['updater_id' => 'id']);
    }
}
