 ...
 * - `quiz_sorter`
 */
class m170716_111159_create_quiz_character_to_sorter_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createIndex(
            'idx-quiz_character_to_sorter-quiz_character_id',
        ...
        $this->addForeignKey(
            'fk-quiz_character_to_sorter-quiz_character_id',
            'quiz_character_to_sorter',
            'quiz_character_id',
            'quiz_character',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_character_to_sorter-quiz_sorter_id',
            'quiz_character_to_sorter',
            'quiz_sorter_id'
        );
        ...
        $this->addForeignKey(
            'fk-quiz_character_to_sorter-quiz_sorter_id',
            'quiz_character_to_sorter',
            'quiz_sorter_id',
            'quiz_sorter',
            'id',
