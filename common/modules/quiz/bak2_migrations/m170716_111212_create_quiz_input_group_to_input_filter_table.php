 ...
 * - `quiz_filter`
 */
class m170716_111212_create_quiz_input_group_to_input_filter_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_input_group_to_input_filter', [
            ...
            'quiz_input_filter_id' => $this->integer()->notNull(),
        ], $tableOptions);

        // creates index for column `quiz_input_group_id`
        $this->createIndex(
            'idx-quiz_input_group_to_input_filter-quiz_input_group_id',
        ...
        $this->addForeignKey(
            'fk-quiz_input_group_to_input_filter-quiz_input_group_id',
            'quiz_input_group_to_input_filter',
            'quiz_input_group_id',
            'quiz_input_group',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_input_group_to_input_filter-quiz_input_filter_id',
            'quiz_input_group_to_input_filter',
        ...
        $this->addForeignKey(
            'fk-quiz_input_group_to_input_filter-quiz_input_filter_id',
            'quiz_input_group_to_input_filter',
            'quiz_input_filter_id',
            'quiz_filter',
            'id',
