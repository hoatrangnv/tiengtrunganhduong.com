...
class m170709_184726_create_quiz_result_to_shape_filter_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('quiz_result_to_shape_filter', [
            ...
            'shape_filter_id' => $this->integer()->notNull(),
        ], $tableOptions);
        ...
        // creates index for column `shape_filter_id`
        $this->createIndex(
            'idx-quiz_result_to_shape_filter-shape_filter_id',
            'quiz_result_to_shape_filter',
            'shape_filter_id'
        );
        ...
        $this->addForeignKey(
            'fk-quiz_result_to_shape_filter-shape_filter_id',
            'quiz_result_to_shape_filter',
            'shape_filter_id',
            'quiz_filter',
            'id',
    ...
    public function down()
    {
        ...
        // drops index for column `shape_filter_id`
        $this->dropIndex(
            'idx-quiz_result_to_shape_filter-shape_filter_id',
            'quiz_result_to_shape_filter'
        );
