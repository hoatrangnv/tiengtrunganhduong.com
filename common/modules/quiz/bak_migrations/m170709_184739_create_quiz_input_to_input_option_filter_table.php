...
class m170709_184739_create_quiz_input_to_input_option_filter_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('quiz_input_to_input_option_filter', [
            ...
            'input_option_filter_id' => $this->integer()->notNull(),
        ], $tableOptions);
        ...
        // creates index for column `input_option_filter_id`
        $this->createIndex(
            'idx-quiz_input_to_input_option_filter-input_option_filter_id',
            'quiz_input_to_input_option_filter',
            'input_option_filter_id'
        );

        // add foreign key for table `quiz_filter`
        $this->addForeignKey(
            'fk-quiz_input_to_input_option_filter-input_option_filter_id',
            'quiz_input_to_input_option_filter',
            'input_option_filter_id',
            'quiz_filter',
            'id',
    ...
    public function down()
    {
        ...
        // drops index for column `input_option_filter_id`
        $this->dropIndex(
            'idx-quiz_input_to_input_option_filter-input_option_filter_id',
            'quiz_input_to_input_option_filter'
        );
