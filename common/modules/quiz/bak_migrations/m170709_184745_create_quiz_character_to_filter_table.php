 ...
 * - `quiz_filter`
 */
class m170709_184745_create_quiz_character_to_filter_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createIndex(
            'idx-quiz_character_to_filter-character_id',
        ...
        $this->addForeignKey(
            'fk-quiz_character_to_filter-character_id',
            'quiz_character_to_filter',
            'character_id',
            'quiz_character',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_character_to_filter-filter_id',
            'quiz_character_to_filter',
            'filter_id'
        );
        ...
        $this->addForeignKey(
            'fk-quiz_character_to_filter-filter_id',
            'quiz_character_to_filter',
            'filter_id',
            'quiz_filter',
            'id',
