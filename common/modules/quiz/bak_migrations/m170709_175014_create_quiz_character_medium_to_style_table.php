 ...
 * - `quiz_style`
 */
class m170709_175014_create_quiz_character_medium_to_style_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createIndex(
            'idx-quiz_character_medium_to_style-character_medium_id',
        ...
        $this->addForeignKey(
            'fk-quiz_character_medium_to_style-character_medium_id',
            'quiz_character_medium_to_style',
            'character_medium_id',
            'quiz_character_medium',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_character_medium_to_style-style_id',
            'quiz_character_medium_to_style',
            'style_id'
        );
        ...
        $this->addForeignKey(
            'fk-quiz_character_medium_to_style-style_id',
            'quiz_character_medium_to_style',
            'style_id',
            'quiz_style',
            'id',
