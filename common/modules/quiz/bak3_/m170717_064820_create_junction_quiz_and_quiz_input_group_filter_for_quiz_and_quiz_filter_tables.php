 ...
 * - `quiz_filter`
 */
class m170717_064820_create_junction_quiz_and_quiz_input_group_filter_for_quiz_and_quiz_filter_tables extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_to_input_group_filter', [
            ...
            'quiz_input_group_filter_id' => $this->integer(),
            'PRIMARY KEY(quiz_id, quiz_input_group_filter_id)',
        ], $tableOptions);

        // creates index for column `quiz_id`
        $this->createIndex(
            'idx-quiz_to_inp_group_filter-quiz_id',
        ...
        $this->addForeignKey(
            'fk-quiz_to_inp_group_filter-quiz_id',
            'quiz_to_input_group_filter',
            'quiz_id',
            'quiz',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_to_inp_group_filter-quiz_inp_group_filter_id',
            'quiz_to_input_group_filter',
        ...
        $this->addForeignKey(
            'fk-quiz_to_inp_group_filter-quiz_inp_group_filter_id',
            'quiz_to_input_group_filter',
            'quiz_input_group_filter_id',
            'quiz_filter',
            'id',
