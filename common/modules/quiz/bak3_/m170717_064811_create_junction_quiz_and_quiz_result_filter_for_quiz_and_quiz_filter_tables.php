 ...
 * - `quiz_filter`
 */
class m170717_064811_create_junction_quiz_and_quiz_result_filter_for_quiz_and_quiz_filter_tables extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_to_result_filter', [
            ...
            'quiz_result_filter_id' => $this->integer(),
            'PRIMARY KEY(quiz_id, quiz_result_filter_id)',
        ], $tableOptions);
        ...
        // creates index for column `quiz_result_filter_id`
        $this->createIndex(
            'idx-quiz_to_result_filter-quiz_result_filter_id',
            'quiz_to_result_filter',
        ...
        $this->addForeignKey(
            'fk-quiz_to_result_filter-quiz_result_filter_id',
            'quiz_to_result_filter',
            'quiz_result_filter_id',
            'quiz_filter',
            'id',
    ...
    public function down()
    {
        ...
        // drops index for column `quiz_result_filter_id`
        $this->dropIndex(
            'idx-quiz_to_result_filter-quiz_result_filter_id',
            'quiz_to_result_filter'
        );
