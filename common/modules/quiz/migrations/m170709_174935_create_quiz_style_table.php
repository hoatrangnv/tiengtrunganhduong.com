 ...
 * - `quiz`
 */
class m170709_174935_create_quiz_style_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_style', [
            ...
            'z_index' => $this->integer()->notNull(),
            'opacity' => $this->integer()->notNull(),
            'top' => $this->string()->notNull(),
            'left' => $this->string()->notNull(),
            'width' => $this->string(),
            'height' => $this->string(),
