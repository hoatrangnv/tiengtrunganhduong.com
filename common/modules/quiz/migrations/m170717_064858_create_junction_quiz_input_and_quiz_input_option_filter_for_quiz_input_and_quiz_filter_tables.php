 ...
 * - `quiz_filter`
 */
class m170717_064858_create_junction_quiz_input_and_quiz_input_option_filter_for_quiz_input_and_quiz_filter_tables extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_input_to_input_option_filter', [
            ...
            'quiz_input_option_filter_id' => $this->integer(),
            'PRIMARY KEY(quiz_input_id, quiz_input_option_filter_id)',
        ], $tableOptions);

        // creates index for column `quiz_input_id`
        $this->createIndex(
            'idx-quiz_inp_to_inp_opt_filter-quiz_inp_id',
        ...
        $this->addForeignKey(
            'fk-quiz_inp_to_inp_opt_filter-quiz_inp_id',
            'quiz_input_to_input_option_filter',
            'quiz_input_id',
            'quiz_input',
            'id',
