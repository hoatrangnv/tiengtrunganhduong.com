 ...
 * - `quiz_filter`
 */
class m170716_111207_create_quiz_to_character_filter_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_to_character_filter', [
            ...
            'quiz_character_filter_id' => $this->integer()->notNull(),
        ], $tableOptions);

        // creates index for column `quiz_id`
        $this->createIndex(
            'idx-quiz_to_character_filter-quiz_id',
        ...
        $this->addForeignKey(
            'fk-quiz_to_character_filter-quiz_id',
            'quiz_to_character_filter',
            'quiz_id',
            'quiz',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_to_character_filter-quiz_character_filter_id',
            'quiz_to_character_filter',
        ...
        $this->addForeignKey(
            'fk-quiz_to_character_filter-quiz_character_filter_id',
            'quiz_to_character_filter',
            'quiz_character_filter_id',
            'quiz_filter',
            'id',
