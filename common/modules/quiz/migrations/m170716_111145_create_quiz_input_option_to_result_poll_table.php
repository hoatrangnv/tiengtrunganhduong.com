 ...
 * - `quiz_input_option`
 */
class m170716_111145_create_quiz_input_option_to_result_poll_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createIndex(
            'idx-quiz_input_option_to_result_poll-quiz_result_id',
        ...
        $this->addForeignKey(
            'fk-quiz_input_option_to_result_poll-quiz_result_id',
            'quiz_input_option_to_result_poll',
            'quiz_result_id',
            'quiz_result',
            'id',
        ...
        $this->createIndex(
            'idx-quiz_input_option_to_result_poll-quiz_input_option_id',
            'quiz_input_option_to_result_poll',
        ...
        $this->addForeignKey(
            'fk-quiz_input_option_to_result_poll-quiz_input_option_id',
            'quiz_input_option_to_result_poll',
            'quiz_input_option_id',
            'quiz_input_option',
            'id',
