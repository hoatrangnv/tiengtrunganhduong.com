 ...
 * - `quiz_filter`
 */
class m170717_064843_create_junction_quiz_result_and_quiz_shape_filter_for_quiz_result_and_quiz_filter_tables extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_result_to_shape_filter', [
            ...
            'quiz_shape_filter_id' => $this->integer(),
            'PRIMARY KEY(quiz_result_id, quiz_shape_filter_id)',
        ], $tableOptions);
