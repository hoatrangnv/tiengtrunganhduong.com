 ...
 * - `quiz`
 */
class m170716_111143_create_quiz_sorter_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_sorter', [
            ...
            'quiz_rule_fn_id' => $this->integer()->notNull(),
            'quiz_id' => $this->integer(),
        ], $tableOptions);

        // creates index for column `quiz_rule_fn_id`
        $this->createIndex(
            'idx-quiz_sorter-quiz_rule_fn_id',
            'quiz_sorter',
            'quiz_rule_fn_id'
        );
        ...
        $this->addForeignKey(
            'fk-quiz_sorter-quiz_rule_fn_id',
            'quiz_sorter',
            'quiz_rule_fn_id',
            'quiz_fn',
            'id',
    ...
    public function down()
    {
        ...
        // drops index for column `quiz_rule_fn_id`
        $this->dropIndex(
            'idx-quiz_sorter-quiz_rule_fn_id',
            'quiz_sorter'
        );
