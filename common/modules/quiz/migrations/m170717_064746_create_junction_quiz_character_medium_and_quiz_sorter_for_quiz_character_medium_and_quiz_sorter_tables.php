 ...
 * - `quiz_sorter`
 */
class m170717_064746_create_junction_quiz_character_medium_and_quiz_sorter_for_quiz_character_medium_and_quiz_sorter_tables extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_character_medium_to_sorter', [
            ...
            'PRIMARY KEY(quiz_character_medium_id, quiz_sorter_id)',
        ], $tableOptions);
