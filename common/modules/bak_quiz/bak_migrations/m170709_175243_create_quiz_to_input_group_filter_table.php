 ...
 * - `quiz_filter`
 */
class m170709_175243_create_quiz_to_input_group_filter_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_to_input_group_filter', [
            ...
            'input_group_filter_id' => $this->integer()->notNull(),
        ], $tableOptions);
        ...
        // creates index for column `input_group_filter_id`
        $this->createIndex(
            'idx-quiz_to_input_group_filter-input_group_filter_id',
            'quiz_to_input_group_filter',
            'input_group_filter_id'
        );

        // add foreign key for table `quiz_filter`
        $this->addForeignKey(
            'fk-quiz_to_input_group_filter-input_group_filter_id',
            'quiz_to_input_group_filter',
            'input_group_filter_id',
            'quiz_filter',
            'id',
    ...
    public function down()
    {
        ...
        // drops index for column `input_group_filter_id`
        $this->dropIndex(
            'idx-quiz_to_input_group_filter-input_group_filter_id',
            'quiz_to_input_group_filter'
        );
