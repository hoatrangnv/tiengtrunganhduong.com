php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_category_table --fields="name:string:notNull:unique,slug:string:notNull:unique,description:string(511),meta_title:string,meta_description:string(511),meta_keywords:string(511),sort_order:integer,active:integer,visible:integer,doindex:integer,dofollow:integer,featured:integer,create_time:integer:notNull,update_time:integer:notNull,creator_id:integer:notNull:foreignKey(user),updater_id:integer:notNull:foreignKey(user),image_id:integer:foreignKey,parent_id:integer:foreignKey(quiz_category)"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_table --fields="name:string:notNull:unique,slug:string:notNull:unique,introduction:text,duration:integer,description:string(511),meta_title:string,meta_description:string(511),meta_keywords:string(511),sort_order:integer,active:integer,visible:integer,doindex:integer,dofollow:integer,featured:integer,create_time:integer:notNull,update_time:integer:notNull,publish_time:integer:notNull,creator_id:integer:notNull:foreignKey(user),updater_id:integer:notNull:foreignKey(user),image_id:integer:foreignKey,quiz_category_id:integer:foreignKey(quiz_category)"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_result_table --fields="name:string:notNull,title:string,description:string(511),content:text,priority:integer,canvas_width:integer,canvas_height:integer,quiz_id:integer:notNull:foreignKey"
...
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_fn_table --fields="name:string:notNull,description:string(511),parameters:string:notNull,body:text:notNull"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_object_filter_table --fields="name:string:notNull,affected_object_type:string:notNull,task_order:integer:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,quiz_id:integer:notNull:foreignKey"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_character_data_filter_table --fields="name:string:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,quiz_character_id:integer:notNull:foreignKey"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_character_medium_data_filter_table --fields="name:string:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,quiz_character_medium_id:integer:notNull:foreignKey"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_character_data_sorter_table --fields="name:string:notNull,apply_order:integer:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,quiz_character_id:integer:notNull:foreignKey"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_character_medium_data_sorter_table --fields="name:string:notNull,apply_order:integer:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,quiz_character_medium_id:integer:notNull:foreignKey"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_input_validator_table --fields="name:string:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,quiz_id:integer:foreignKey"
php yii my-migrate/create --migrationPath="@quiz/migrations" create_quiz_param_table --fields="name:string:notNull,var_name:string:notNull,arguments:string:notNull,quiz_fn_id:integer:notNull:foreignKey,task_order:integer:notNull,quiz_id:integer:notNull:foreignKey"
