 ...
 * - `quiz`
 */
class m170716_111118_create_quiz_param_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('quiz_param', [
            ...
            'quiz_value_fn_id' => $this->integer()->notNull(),
            'global_exec_order' => $this->integer()->notNull(),
            'quiz_id' => $this->integer()->notNull(),
        ], $tableOptions);

        // creates index for column `quiz_value_fn_id`
        $this->createIndex(
            'idx-quiz_param-quiz_value_fn_id',
            'quiz_param',
            'quiz_value_fn_id'
        );
        ...
        $this->addForeignKey(
            'fk-quiz_param-quiz_value_fn_id',
            'quiz_param',
            'quiz_value_fn_id',
            'quiz_fn',
            'id',
    ...
    public function down()
    {
        ...
        // drops index for column `quiz_value_fn_id`
        $this->dropIndex(
            'idx-quiz_param-quiz_value_fn_id',
            'quiz_param'
        );
