 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'common\modules\gii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'common\modules\gii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'common\modules\gii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'common\modules\gii\generators\model\Generator'],
            'crud' => ['class' => 'common\modules\gii\generators\crud\Generator'],
            'controller' => ['class' => 'common\modules\gii\generators\controller\Generator'],
            'form' => ['class' => 'common\modules\gii\generators\form\Generator'],
            'module' => ['class' => 'common\modules\gii\generators\module\Generator'],
            'extension' => ['class' => 'common\modules\gii\generators\extension\Generator'],
        ];
    }
}
